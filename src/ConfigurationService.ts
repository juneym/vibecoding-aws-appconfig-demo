...
export class ConfigurationService extends EventEmitter implements ConfigurationServiceInterface {
    ...
    async #pollOnce(profile: any): Promise<void> {
        ...
        console.log(`[Polling] Profile: ${profile.Name} at ${new Date().toISOString()}`);
